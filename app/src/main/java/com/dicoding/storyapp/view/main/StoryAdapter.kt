...
import com.dicoding.storyapp.databinding.StoryWidgetBinding
...
class StoryAdapter :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StoryViewHolder {
        val binding = StoryWidgetBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class StoryViewHolder(val binding: StoryWidgetBinding) : RecyclerView.ViewHolder(binding.root) {
